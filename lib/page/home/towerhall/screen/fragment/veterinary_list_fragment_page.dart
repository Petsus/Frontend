...
class VeterinaryListFragmentPage extends StatefulWidget {
  ...
  final IVeterinaryRouter router;

  const VeterinaryListFragmentPage({
    super.key,
    required this.bloc,
            ...
            child: Observer(builder: (context) {
              return ListView.separated(
                itemBuilder: (_, index) => VeterinaryCard(
                  ...
                  callback: () => widget.router.details(context: context, veterinary: widget.bloc.veterinaries[index]),
                ),
