...
part of 'veterinary_list_bloc.dart';
...
mixin _$VeterinaryListBloc on AbstractVeterinaryListBloc, Store {
  ...
  bool get isOrderByDate =>
      (_$isOrderByDateComputed ??= Computed<bool>(() => super.isOrderByDate,
              name: 'AbstractVeterinaryListBloc.isOrderByDate'))
          .value;

  late final _$orderByAtom =
      Atom(name: 'AbstractVeterinaryListBloc.orderBy', context: context);
  ...
  late final _$pageAtom =
      Atom(name: 'AbstractVeterinaryListBloc.page', context: context);
  ...
  late final _$pageCountAtom =
      Atom(name: 'AbstractVeterinaryListBloc.pageCount', context: context);
  ...
  late final _$loadPageAsyncAction =
      AsyncAction('AbstractVeterinaryListBloc.loadPage', context: context);
  ...
  late final _$orderByNameAsyncAction =
      AsyncAction('AbstractVeterinaryListBloc.orderByName', context: context);
  ...
  late final _$orderByDateAsyncAction =
      AsyncAction('AbstractVeterinaryListBloc.orderByDate', context: context);
  ...
  late final _$filterAsyncAction =
      AsyncAction('AbstractVeterinaryListBloc.filter', context: context);
